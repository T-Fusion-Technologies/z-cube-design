	...
	<li class="nav-item"> <a <?php if($page == "#"){?> class="active" <?php }?> href="#"> Millwork </a> </li> 
	...
	<li class="nav-item"> <a <?php if($page == "work-with-us"){?> class="active" <?php }?> href="work-with-us.php"> Work with Us </a> </li> 
