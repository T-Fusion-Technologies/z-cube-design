			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-3 col-md-4 social text-right">
						<a href="assets/pdf/ZDPL-Work-Profile-Updated.pdf" download="ZDPL-Work-Profile-Updated.PDF" class="btn btn-theme">download portfolio <span><i class="fa fa-download" aria-hidden="true"></i></span></a>
	...
	<div class="side_menu">
		...
		<div class="menu-footer right-boxed">
			<div class="social-list">
				<a class="icon ion-social-twitter" target="_blank" href="#"> </a>
				<a class="icon ion-social-facebook" target="_blank" href="#"> </a>
				<a class="icon ion-social-googleplus" target="_blank" href="#"> </a>
			</div>
			<div class="copy"> &copy; 2022 ZCube Design. All Rights Reserved </div>
		</div>
	</div>
