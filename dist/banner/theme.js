    ...
    */
    function photography_slider() {
        if ($('#home_full_slider').length) {
            ...
            $("#home_full_slider").revolution((_$$revolution = {
                sliderType: "standard",
                ...
                stopAtSlide: -1,
                shuffle: "off"
            }, _defineProperty(_$$revolution, 'autoHeight', "off"), _defineProperty(_$$revolution, 'fullScreenAutoWidth', "off"), _defineProperty(_$$revolution, 'fullScreenAlignForce', "off"), _defineProperty(_$$revolution, 'fullScreenOffsetContainer', ""), _defineProperty(_$$revolution, 'fullScreenOffset', ""), _defineProperty(_$$revolution, 'disableProgressBar', "on"), _defineProperty(_$$revolution, 'hideThumbsOnMobile', "off"), _defineProperty(_$$revolution, 'hideSliderAtLimit', 0), _defineProperty(_$$revolution, 'hideCaptionAtLimit', 0), _defineProperty(_$$revolution, 'hideAllCaptionAtLilmit', 0), _defineProperty(_$$revolution, 'debugMode', false), _defineProperty(_$$revolution, 'fallbacks', {
                simplifyAll: "off",
                nextSlideOnWindowFocus: "off",
                disableFocusListener: false
            }), _defineProperty(_$$revolution, 'parallax', {
                type: "mouse",
                origo: "slidercenter",
                speed: 2000,
    ...
    function full_page_slider() {
        if ($('#full_page_slider').length) {
            ...
            $("#full_page_slider").revolution((_$$revolution2 = {
                sliderType: "standard",
                sliderLayout: 'fullscreen',
                dottedOverlay: "none",
                delay: 5000,
                ...
                stopAtSlide: -1,
                shuffle: "off"
            }, _defineProperty(_$$revolution2, 'autoHeight', "off"), _defineProperty(_$$revolution2, 'fullScreenAutoWidth', "off"), _defineProperty(_$$revolution2, 'fullScreenAlignForce', "off"), _defineProperty(_$$revolution2, 'fullScreenOffsetContainer', ""), _defineProperty(_$$revolution2, 'fullScreenOffset', "80"), _defineProperty(_$$revolution2, 'disableProgressBar', "on"), _defineProperty(_$$revolution2, 'hideThumbsOnMobile', "off"), _defineProperty(_$$revolution2, 'hideSliderAtLimit', 0), _defineProperty(_$$revolution2, 'hideCaptionAtLimit', 0), _defineProperty(_$$revolution2, 'hideAllCaptionAtLilmit', 0), _defineProperty(_$$revolution2, 'debugMode', false), _defineProperty(_$$revolution2, 'fallbacks', {
                simplifyAll: "off",
                nextSlideOnWindowFocus: "off",
                disableFocusListener: false
            }), _$$revolution2));
