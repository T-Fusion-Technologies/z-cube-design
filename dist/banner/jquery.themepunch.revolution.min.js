...
!function (jQuery, undefined) {
    ...
    jQuery.fn.extend({
        ...
        revremoveslide: function revremoveslide(a) {
        ...
        revaddcallback: function revaddcallback(a) {
            return this.each(function () {
        ...
        revscroll: function revscroll(a) {
            return this.each(function () {
                var b = jQuery(this);
        ...
        revredraw: function revredraw(a) {
            return this.each(function () {
                var a = jQuery(this);
                containerResized(a, a[0].opt);
            });
        },
        revkill: function revkill(a) {
            var b = this,
                c = jQuery(this);
    ...
    jQuery.extend(!0, _R, {
        ...
        compare_version: function compare_version(a) {
        ...
        currentSlideIndex: function currentSlideIndex(a) {
            var b = a.c.find(".active-revslide").index();
            return b = b == -1 ? 0 : b;
        },
        simp: function simp(a, b, c) {
        ...
        callBackHandling: function callBackHandling(a, b, c) {
            try {
        ...
        getHorizontalOffset: function getHorizontalOffset(a, b) {
        ...
        callingNewSlide: function callingNewSlide(a, b) {
        ...
        slotSize: function slotSize(a, b) {
        ...
        setSize: function setSize(a) {
            ...
            } : a.paddings, a.rowzones && a.rowzones.length > 0) for (var h = 0; h < a.rowzones[g].length; h++) {
    ...
    var _ISM = _R.is_mobile(),
        checkIDS = function checkIDS(a, b) {
        ...
        removeArray = function removeArray(a, b) {
        var c = [];
        return jQuery.each(a, function (a, d) {
            a != b && c.push(d);
        }), c;
    },
        removeNavWithLiref = function removeNavWithLiref(a, b, c) {
        c.c.find(a).each(function () {
            var a = jQuery(this);
            a.data("liref") === b && a.remove();
        });
    },
        lAjax = function lAjax(a, b) {
        ...
        getNeededScripts = function getNeededScripts(a, b) {
        var c = new Object(),
            d = a.navigation;
        return c.kenburns = !1, c.parallax = !1, c.carousel = !1, c.navigation = !1, c.videos = !1, c.actions = !1, c.layeranim = !1, c.migration = !1, b.data("version") && b.data("version").toString().match(/5./gi) ? (b.find("img").each(function () {
            ...
            "object" == (typeof c === "undefined" ? "undefined" : _typeof(c)) && c.fileprefix != undefined && lAjax(c.fileprefix, a);
        }), c;
    },
        waitForScripts = function waitForScripts(a, b) {
        var c = !0,
            d = b.scriptsneeded;
        b.addons != undefined && b.addons.length > 0 && jQuery.each(b.addons, function (a, b) {
            "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) && b.init != undefined && _R[b.init] === undefined && (c = !1);
        ...
        getScriptLocation = function getScriptLocation(a) {
        ...
        setCurWinRange = function setCurWinRange(a, b) {
        var d = 9999,
            e = 0,
            f = 0,
            g = 0,
        ...
        prepareOptions = function prepareOptions(a, b) {
        ...
        gWiderOut = function gWiderOut(a, b) {
        var c = 0;
        ...
        runSlider = function runSlider(a, b) {
        ...
        cArray = function cArray(a, b) {
        if (!jQuery.isArray(a)) {
            var c = a;
            a = new Array(), a.push(c);
        }
        if (a.length < b) for (var c = a[a.length - 1], d = 0; d < b - a.length + 2; d++) {
            a.push(c);
        }return a;
    },
        checkHoverDependencies = function checkHoverDependencies(a, b) {
        var c = a.data(),
        ...
        contWidthManager = function contWidthManager(a) {
        ...
        hideSliderUnder = function hideSliderUnder(a, b, c) {
        var d = a.parent();
        ...
        containerResized = function containerResized(a, b) {
        ...
        prepareSlides = function prepareSlides(a, b) {
        ...
        imgLoaded = function imgLoaded(a, b, c) {
        ...
        progressImageLoad = function progressImageLoad(a) {
        ...
        addToLoadQueue = function addToLoadQueue(a, b, c, d, e) {
        var f = !1;
        ...
        loadImages = function loadImages(a, b, c, d) {
        ...
        getLoadObj = function getLoadObj(a, b) {
        var c = new Object();
        return a.loadqueue && jQuery.each(a.loadqueue, function (a, d) {
            d.src == b && (c = d);
        }), c;
    },
        waitForCurrentImages = function waitForCurrentImages(a, b, c) {
        var d = !1;
        a.find("img,.defaultimg, .tp-svg-layer").each(function () {
            var c = jQuery(this),
            ...
            if (c.data("loaded") === undefined && f !== undefined && f.progress && f.progress.match(/loaded/g)) {
                if (c.attr("src", f.src), "img" == f.type) {
                    ...
                    }), a.data("owidth", f.width), a.data("oheight", f.height), a.find(".slotholder").data("owidth", f.width), a.find(".slotholder").data("oheight", f.height);else {
                        var g = c.data("ww"),
                            h = c.data("hh");
        ...
        swapSlide = function swapSlide(a) {
        var b = a[0].opt;
        ...
        swapSlideProgress = function swapSlideProgress(a, b) {
        ...
        letItFree = function letItFree(a, b, c, d, e, f) {
        var g = a[0].opt;
        ...
        removeAllListeners = function removeAllListeners(a, b) {
        ...
        countDown = function countDown(a, b) {
        ...
        restartOnFocus = function restartOnFocus(a) {
        ...
        lastStatBlur = function lastStatBlur(a) {
        ...
        tabBlurringCheck = function tabBlurringCheck(a, b) {
        ...
        getUrlVars = function getUrlVars(a) {
